...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'Telegram',
      url: 'https://t.me/Aquasofts',     // Internal links should not include the base path, as it is automatically added
  ...
  links: [
    {
      ...
      url: 'https://X.com/Aquasoft_520',
    },
    {
      name: 'Telegram',
      icon: 'logos:telegram',
      url: 'https://t.me/Aquasofts',
    },
    {
      name: 'GitHub',
